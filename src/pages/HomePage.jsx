    ...
    <div style={styles.container}>
      ...
      <div style={styles.content}>
        <div style={styles.hero}>
          ...
          <h1 style={styles.title}>Book a home cleaning in minutes</h1>
          <p style={styles.subtitle}>
            CleanEasy keeps customers and cleaners on the same page. Schedule,
            track, and complete bookings without juggling chats or spreadsheets.
          </p>
        ...
        <div style={styles.features}>
          <div style={styles.feature}>
            ...
            <div style={styles.featureText}>
              Schedule cleanings on your terms, anytime
            </div>
          </div>
          <div style={styles.feature}>
            <div style={styles.featureIcon}>⚡</div>
